# verb-AAD.psm1
  ...
  REVISIONS
  * 12/17/2019 - 1.0.0
  * 10:55 AM 12/6/2019 Connect-MSOL & Connect-AAD:added suffix to TitleBar tag for non-CO tenants, also config'd a central tab vari
* 1:07 PM 11/25/2019 added *ABC/*ABC/*ABC alias variants for connect & reconnect
...
* 11:56 AM 12/7/2018 init version, added Alias connect-msol -> connect-aad
  ...
  Server Fqdn (24-25char) [-serverFqdn Server0.domain.com)] 
  .PARAMETER  Server
  Server NBname (8-9chars) [-server Server0)]
  .PARAMETER  SiteName
  Specify Site to analyze [-SiteName (Server$3|GBMK|AUSYD]
  .PARAMETER  Ticket
  Ticket # [-Ticket nnnnn]
  .PARAMETER  Path
  Path [-path c:\path-to\]
...
if(!(test-path function:\Build-AADSignErrorsHash)) {
    ...
    function Build-AADSignErrorsHash {
        ...
        Additional Credits: Sign-in activity report error codes in the Azure Active DirecABCy portal
        Website:	https://docs.microsoft.com/en-us/azure/active-direcABCy/reports-moniABCing/reference-sign-ins-error-codes
        REVISIONS   :
        * 8:50 PM 1/12/2020 expanded aliases
        * 10:41 AM 5/13/2019 init vers
        .DESCRIPTION
        Build-AADSignErrorsHas.ps1 - Builds a hash object containing AzureAD Sign-on Error codes & matching description: [Sign-in activity report error codes in the Azure Active DirecABCy portal | Microsoft Docs](https://docs.microsoft.com/en-us/azure/active-direcABCy/reports-moniABCing/reference-sign-ins-error-codes)
        .INPUTS
        ...
        .EXAMPLE
        .LINK
        https://docs.microsoft.com/en-us/azure/active-direcABCy/reports-moniABCing/reference-sign-ins-error-codes)
        #>
        ...
        $AADSignOnError.add("50001", "The service principal name was not found in this tenant. This can happen if the application has not been installed by the administraABC of the tenant, or if the resource principal was not found in the direcABCy or is invalid.") ;
        ...
        $AADSignOnError.add("50006", "Signature verification failed due to invalid signature. Check out the resolution outlined at https://docs.microsoft.com/azure/active-direcABCy/application-sign-in-problem-federated-sso-gallery. If the issue persists, contact the application owner or application administraABC.") ;
        ...
        $AADSignOnError.add("50011", "The reply address is missing, misconfigured, or does not match reply addresses configured for the application. Try the resolution listed at https://docs.microsoft.com/azure/active-direcABCy/application-sign-in-problem-federated-sso-gallery#the-reply-address-does-not-match-the-reply-addresses-configured-for-the-application. If the issue persists, contact the application owner or application administraABC.") ;
        ...
        $AADSignOnError.add("50017", "Certification validation failed, reasons for the following reasons:, Cannot find issuing certificate in trusted certificates list , Unable to find expected CrlSegment , Cannot find issuing certificate in trusted certificates list , Delta CRL distribution point is configured without a corresponding CRL distribution point , Unable to retrieve valid CRL segments due to timeout issue , Unable to download CRL , Contact the tenant administraABC.") ;
        ...
        $AADSignOnError.add("50029", "Invalid URI - domain name contains invalid characters. Contact the tenant administraABC.") ;
        $AADSignOnError.add("50034", "User does not exist in direcABCy. Contact your tenant administraABC.") ;
        $AADSignOnError.add("50042", "The salt required to generate a pairwise identifier is missing in principle. Contact the tenant administraABC.") ;
        $AADSignOnError.add("50048", "Subject mismatches Issuer claim in the client assertion. Contact the tenant administraABC.") ;
        ...
        $AADSignOnError.add("50056", "Invalid or null password - Password does not exist in sABCe for this user.") ;
        $AADSignOnError.add("50057", "User account is disabled. The account has been disabled by an administraABC.") ;
        ...
        $AADSignOnError.add("50059", "User does not exist in direcABCy. Contact your tenant administraABC.") ;
        $AADSignOnError.add("50061", "Sign-out request is invalid. Contact the application owner.") ;
        $AADSignOnError.add("50072", "User needs to enroll for two-facABC authentication (interactive).") ;
        ...
        $AADSignOnError.add("50079", "User needs to enroll for two facABC authentication (non-interactive logins).") ;
        ...
        $AADSignOnError.add("50105", "The signed in user is not assigned to a role for the signed in application. Assign the user to the application. For more information: https://docs.microsoft.com/azure/active-direcABCy/application-sign-in-problem-federated-sso-gallery#user-not-assigned-a-role") ;
        $AADSignOnError.add("50107", "Requested federation realm object does not exist. Contact the tenant administraABC.") ;
        $AADSignOnError.add("50120", "Issue with JWT header. Contact the tenant administraABC.") ;
        $AADSignOnError.add("50124", "Claims Transformation contains invalid input parameter. Contact the tenant administraABC to update the policy.") ;
        ...
        $AADSignOnError.add("50144", "Users Active DirecABCy password has expired. Generate a new password for the user or have the end user using self-service reset tool.") ;
        ...
        $AADSignOnError.add("50172", "External claims provider is not approved. Contact the tenant administraABC") ;
        ...
        $AADSignOnError.add("51004", "User account doesnt exist in the direcABCy.") ;
        ...
        $AADSignOnError.add("53004", "User needs to complete Multi-facABC authentication registration process before accessing this content. User should register for multi-facABC authentication.") ;
        $AADSignOnError.add("65001", "Application X doesnt have permission to access application Y or the permission has been revoked. Or The user or administraABC has not consented to use the application with ID X. Send an interactive authorization request for this user and resource. Or The user or administraABC has not consented to use the application with ID X. Send an authorization request to your tenant admin to act on behalf of the App : Y for Resource : Z.") ;
        ...
        $AADSignOnError.add("70001", "The application named X was not found in the tenant named Y. This can happen if the application with identifier X has not been installed by the administraABC of the tenant or consented to by any user in the tenant. You might have misconfigured the Identifier value for the application or sent your authentication request to the wrong tenant.") ;
        ...
        $AADSignOnError.add("80001", "Authentication Agent unable to connect to Active DirecABCy. Make sure the authentication agent is installed on a domain-joined machine that has line of sight to a DC that can serve the users login request.") ;
        ...
        $AADSignOnError.add("80003", "Invalid response received by Authentication Agent. An unknown error occurred while attempting to authentication against Active DirecABCy on-premises. Open a support ticket to get more details on the error.") ;
        ...
        $AADSignOnError.add("90094", "The grant requires administraABC permissions. Ask your tenant administraABC to provide consent for this application.") ;
...
if(!(test-path function:Connect-AAD)){
    Function Connect-AAD {
        ...
        REVISIONS   :
        * 10:55 AM 12/6/2019 Connect-AAD:added suffix to TitleBar tag for non-CO tenants, also config'd a central tab vari
        ...
        * 1:54 PM 10/8/2018 Connect-AAD:port from Connect-AAD
        ...
        Param(
            ...
            [Parameter()]$Credential = $global:credo365ABCSID
        ) ;
        ...
        if($Credential){
            switch -regex ($Credential.username.split('@')[1]){
                "MYDOMAIN\user.com" {
                 ...
                 "DOMAIN\.com" {
                    $sTitleBarTag = $sTitleBarTag + "LAB"
                }
                "(DOMAIN\.onmicrosoft\.com|DOMAIN\.works)" {
                    $sTitleBarTag = $sTitleBarTag + "ABC"
                }
            } ;
        } ;

        Try {Get-Module AzureAD -listavailable -ErrorAction Stop | out-null } Catch {Install-Module AzureAD -scope CurrentUser ; } ;                 # installed
        Try {Get-Module AzureAD -ErrorAction Stop | out-null } Catch {Import-Module -Name AzureAD -MinimumVersion '192.168.0.1' -ErrorAction Stop  } ; # imported
...
function caadABC {Connect-AAD -cred $credO365ABCSID};
function caadABC {Connect-AAD -cred $credO365ABCCSID};
function caadABC {Connect-AAD -cred $credO365ABCSID}
...
function connect-AzureRM {
    ...
    $MFA=$false ;
    # 8:32 AM 11/19/2019 DOMAIN is mfa now, need to check
...
if(!(test-path function:connect-msol)){
    Function Connect-MSOL {
        ...
        REVISIONS   :
        * 8:50 PM 1/12/2020 expanded aliases
        * 10:55 AM 12/6/2019 Connect-MSOL:added suffix to TitleBar tag for non-CO tenants, also config'd a central tab vari
        * 1:07 PM 11/25/2019 added *ABC/*ABC/*ABC alias variants for connect & reconnect
        * 9:19 AM 11/19/2019 added MFA tenant detect (fr cred), and code to support MFA
        ...
        * 7:38 AM 10/5/2018 out-null the pretesting Get-MsolAccounMyAccountu into a vari (was dumping into console)
        ...
        * 12:19 PM 11/3/2017 this wasn't really written, sketched it in to see how it works
        ...
        <# expl of my profile xml credential sABCage points by account
        $LUAuid="MYDOMAIN\user" ;
        $SIDDomLogon="MYDOMAIN\user" ;
        ...
        try { Get-MsolAccounMyAccountu -ErrorAction Stop | out-null }
...
function cmsolABC {Connect-MSOL -cred $credO365ABCSID};
function cmsolABC {Connect-MSOL -cred $credO365ABCCSID};
function cmsolABC {Connect-MSOL -cred $credO365ABCSID}
...
#*------v Function get-ASITEastSync v------
Function get-ASITEastSync {
  <#
    .SYNOPSIS
    get-ASITEastSync - Get specific user's last AD-AAD sync (AzureAD/MSOL)
    .NOTES
    Updated By: : Todd Kadrie
    Website:	http://tinstoys.blogspot.com
    Twitter:	http://twitter.com/tostka
    REVISIONS   :
    * 8:50 PM 1/12/2020 expanded aliases
    * 9:17 AM 10/9/2018 get-ASITEastSync:simplified the collection, and built a Cobj returned in GMT & local timezone
    * 12:30 PM 11/3/2017 initial version
    .DESCRIPTION
    get-ASITEastSync - Collect last AD-AAD sync (AzureAD/MSOL)
    .PARAMETER Credential
    Credential to be used for connection
    .INPUTS
    None. Does not accepted piped input.
  ...
  Param([Parameter()]$Credential = $global:credo365ABCSID) ;
  try { Get-MsolAccounMyAccountu -ErrorAction Stop | out-null }
  catch [Microsoft.Online.Administration.Automation.MicrosoftOnlineException] {
  ...
  $oReturn = New-Object PSObject -Property @{
    ...
    TimeLocal = $DirSyncTimeBefore.ABCocalTime() ;
  };
  $oReturn | write-output ;
} ; #*------^ END Function get-ASITEastSync ^------
# 11:19 AM 10/18/2018 add msol alias
if(!(get-alias get-MsolLastSync -ea 0) ) {Set-Alias 'get-MsolLastSync' -Value 'get-ASITEastSync' ; }

#*------^ get-ASITEastSync.ps1 ^------
...
Function get-MsolUserLastSync {
  <#
    ...
    * 11:23 AM 10/18/2018 ported from get-MsolUserLastSync()
    ...
    #>
  Param(
    [Parameter(Position = 0, MandaABCy = $True, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "MSolUser UPN")][ValidateNotNullOrEmpty()][string]$UserPrincipalName,
    [Parameter()]$Credential = $global:credo365ABCSID
  ) ;
  try { Get-MsolAccounMyAccountu -ErrorAction Stop | out-null }
  catch [Microsoft.Online.Administration.Automation.MicrosoftOnlineException] {
...
Function get-MsolUserLicenseDetails {
    ...
    Website: https://thelazyadministraABC.com/2018/03/19/get-friendly-license-name-for-all-users-in-office-365-using-powershell/
    REVISIONS   :
    * 8:50 PM 1/12/2020 expanded aliases
    ...
    * 2:58 PM 12/7/2018 initial version
    ...
    Returns an object with LastDirSyncTime, expressed as TimeGMT & TimeLocal
    .EXAMPLE
    get-MsolUserLicenseDetails -UPNs todd.kadrie@DOMAIN.com ;
    ...
    .LINK
    https://thelazyadministraABC.com/2018/03/19/get-friendly-license-name-for-all-users-in-office-365-using-powershell/
    #>
    Param(
        [Parameter(Position = 0, MandaABCy = $True, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "An array of MSolUser objects")][ValidateNotNullOrEmpty()]
        [string]$UPNs,
        [Parameter()]$Credential = $global:credo365ABCSID,
    ...
    # 11:42 AM 1/9/2019 added "MS_TEAMS_IW"      (portal displayname used below)
    # [Product names and service plan identifiers for licensing in Azure Active DirecABCy | Microsoft Docs](https://docs.microsoft.com/en-us/azure/active-direcABCy/users-groups-roles/licensing-service-plan-reference)
    ...
    $Sku = @{
        ...
        "SHAREPOINTSABCAGE"                  = "SharePoint sABCage"
        ...
        "AAD_BASIC"                          = "Azure Active DirecABCy Basic"
        "RMS_S_ENTERPRISE"                   = "Azure Active DirecABCy Rights Management"
        "AAD_PREMIUM"                        = "Azure Active DirecABCy Premium"
        "MFA_PREMIUM"                        = "Azure Multi-FacABC Authentication"
        ...
        "RMS_S_ENTERPRISE_GOV"               = "Windows Azure Active DirecABCy Rights Management"
        "OFFICESUBSCRIPTION_GOV"             = "Office ProPlus"
        "MCOSTANDARD_GOV"                    = "SITEc Plan 2G"
        ...
        "MCOLITE"                            = "SITEc Online (Plan 1)"
        "SHAREPOINTLITE"                     = "SharePoint Online (Plan 1)"
        "OFFICE_PRO_PLUS_SUBSCRIPTION_SMBIZ" = "Office ProPlus"
        "EXCHANGE_S_STANDARD_MIDMARKET"      = "Exchange Online (Plan 1)"
        "MCOSTANDARD_MIDMARKET"              = "SITEc Online (Plan 1)"
        ...
        "SPZA_IW"                            = "App Connect"
        "WINDOWS_SABCE"                      = "Windows SABCe for Business"
    ...
    Foreach ($User in $UPNs) {
        ...
        Do {
            Try {
                #$Licenses = ((Get-MsolUser -UserPrincipalName $User.UserPrincipalName).Licenses).AccounMyAccountuID
                $MsolU = Get-MsolUser -UserPrincipalName $User ;
                $Licenses = $MsolU.Licenses.AccounMyAccountuID
                #$Licenses = ((Get-MsolUser -UserPrincipalName $User).Licenses).AccounMyAccountuID
                $Exit = $Retries ;
            }
            Catch {
        ...
        If (($Licenses).Count -gt 1) {
            Foreach ($License in $Licenses) {
                ...
                If (!($TextLic)) {
                    ...
                    $LicenseFallBackName = $License.AccounMyAccountuId

                    $LicSummary = New-Object PSObject -Property @{
                        DisplayName         = $MsolU.DisplayName ;
                        UserPrincipalName   = $MsolU.Userprincipalname
                        LicAccounMyAccountuID     = $License
                        LicenseFriendSITEame = $LicenseFallBackName
                    };
        ...
        Else {
            ...
            Do {
                Try {
                    #$LicenseItem = ((Get-MsolUser -UserPrincipalName $MsolU.Userprincipalname).Licenses).AccounMyAccountuID -split ":" | Select-Object -Last 1
                    $LicenseID = ((Get-MsolUser -UserPrincipalName $MsolU.Userprincipalname).Licenses).AccounMyAccountuID
            ...
            If (!($TextLic)) {
                ...
                $LicSummary = New-Object PSObject -Property @{
                    DisplayName         = $MsolU.DisplayName
                    UserPrincipalName   = $MsolU.Userprincipalname
                    LicAccounMyAccountuID     = $LicenseID
                    LicenseFriendSITEame = $LicenseFallBackName
                };
                $AggregLics += $LicSummary ;
            }
...
Function Wait-AADSync {
    ...
    REVISIONS   :
    * 8:50 PM 1/12/2020 expanded aliases
    * 11:38 AM 5/6/2019 moved from MyAccountsid-incl-ServerApp.ps1
    * 9:53 AM 3/1/2019 init vers, repl'd native cmsolsvc with Connect-AAD
    ...
    write-host -foregroundcolor yellow "$((get-date).ToString('HH:mm:ss')):Waiting for next AAD Dirsync:`n(prior:$($DirSyncLast.ABCocalTime()))`n[" ;
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwpI1BIHPGN2vq0Y2EwztAzO6
# 4r+gggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQrriSq
# jvFmTgWxYL33TpZV+uZH4DANBgkqhkiG9w0BAQEFAASBgA8trdBwTqSPvzm+Uvn5
# OBP0djfY0oAvvyBOuWcNrUeTQ4Z9ku0sqLWepuv0PThc7fl9H6LUyu1+edUQfwY7
# nP4izeEOTvDEyikB3bNbv+Iue3DOf0vVjXKZ1Vdi2oCO2qCa4EaX/odQjni0URBn
# 8kem/PTpLF7zheSjlrMusZcm
